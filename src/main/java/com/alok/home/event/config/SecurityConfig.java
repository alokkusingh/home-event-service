package com.alok.home.event.config;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http, OncePerRequestFilter customAuthenticationFilter) throws Exception {
        ...
        return http
                ...
                .authorizeHttpRequests(auth -> {
                    ...
                    auth.requestMatchers("/*/subscribe").hasAnyRole("ADMIN", "USER", "LOCALHOST");
                    auth.requestMatchers("/*/emit").hasAnyRole( "ADMIN", "home_event_rw", "LOCALHOST");
